...
namespace System.Data.Linq.SqlClient {
    ...
    internal class SqlConnectionManager : IConnectionManager {
        ...
        public DbConnection UseConnection(IConnectionUser user) {
            if (user == null) {
                 throw new Exception(); //ArgumentNull("user");
            }
                ...
                if (value != this.transaction) {
                    if (value != null) {
                        if (this.connection != value.Connection) {
                             throw new Exception(); //TransactionDoesNotMatchConnection();
                        }
                    }
        ...
        private void OnInfoMessage(object sender, SqlInfoMessageEventArgs args) {
            if (this.provider.Log != null) {
                this.provider.Log.WriteLine("LogGeneralInfoMessage"/*Strings.LogGeneralInfoMessage(args.Source, args.Message)*/);
            }
        }
