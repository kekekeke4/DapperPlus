            ...
            internal override SqlSelect VisitSelect(SqlSelect select) {
                ...
                if (select.Top != null) {
                    if (select.Top.NodeType == SqlNodeType.Value) {
                        ...
                        this.annotations.Add(select.Top, new SqlServerCompatibilityAnnotation("SourceExpressionAnnotation"/*Strings.SourceExpressionAnnotation(select.Top.SourceExpression)*/, SqlProvider.ProviderMode.Sql2000));
                    }
                }
                return select;
            }
