        ...
        private class Visitor : SqlVisitor {
            ...
            private SqlExpression TranslateNewString(SqlNew sox) {
                ...
                if (sox.ClrType == typeof(string) && sox.Args.Count == 2
                 ...
                 throw new Exception(); //UnsupportedStringConstructorForm();
            }
            ...
            private SqlExpression TranslateNewDateTime(SqlNew sox) {
                ...
                if (sox.ClrType == typeof(DateTime) && sox.Args.Count >= 3 &&
                 ...
                 throw new Exception(); //UnsupportedDateTimeConstructorForm();
            }
                    ...
                    if (sox.Args.Count >= 7 &&
                        ...
                        if (sox.Args.Count == 7 && sox.Args[6].ClrType == typeof(TimeSpan)) {
                            ...
                            result = sql.FunctionCall(typeof(DateTimeOffset), "CONVERT", new SqlExpression[3] { datetimeoffset, dateAndTime, sql.ValueFromObject(121, false, source) }, source);
                             ...
                             throw new Exception(); //UnsupportedDateTimeOffsetConstructorForm();
                        }
            ...
            private SqlExpression TranslateNewTimeSpan(SqlNew sox) {
                if (sox.Args.Count == 1) {
                 ...
                 throw new Exception(); //UnsupportedTimeSpanConstructorForm();
            }
                ...
                if (mc.Method.IsStatic) {
                    ...
                    if (mc.Method.Name == "Equals" && mc.Arguments.Count == 1) {
                        ...
                        if (!expr.SqlType.IsRuntimeOnlyType) {
                         ...
                         throw new Exception(); //ToStringOnlySupportedForPrimitiveTypes();
                    }
            ...
            internal static Exception GetMethodSupportException(SqlMethodCall mc) {
                ...
                if (ms == MethodSupport.MethodGroup) {
                    ...
                    return new Exception("MethodFormHasNoSupportConversionToSql"); //Error.MethodFormHasNoSupportConversionToSql(mc.Method.Name, mc.Method);
                } else {
                    // No form of the method is supported
                    return new Exception("MethodHasNoSupportConversionToSql"); //Error.MethodHasNoSupportConversionToSql(mc.Method);
                }
            }
                        ...
                        case "ToDateTime":
                            ...
                            if (nnType == typeof(string) || nnType == typeof(DateTime)) {
                                targetType = typeof(DateTime);
                                 ...
                                 throw new Exception(); //ConvertToDateTimeOnlyForDateTimeOrString();
                            }
                            break;
                ...
                switch (mc.Method.Name) {
                        ...
                        if (mc.Arguments.Count == 1) {
                            ...
                            if (pattern.NodeType == SqlNodeType.Value) {
                                ...
                                pattern = new SqlClientParameter(
                                 ...
                                 throw new Exception(); //NonConstantExpressionsNotSupportedFor("String.Contains");
                            }
                        ...
                        if (mc.Arguments.Count == 1) {
                            ...
                            if (pattern.NodeType == SqlNodeType.Value) {
                                ...
                                pattern = new SqlClientParameter(
                                 ...
                                 throw new Exception(); //NonConstantExpressionsNotSupportedFor("String.StartsWith");
                            }
                        ...
                        if (mc.Arguments.Count == 1) {
                            ...
                            if (pattern.NodeType == SqlNodeType.Value) {
                                ...
                                pattern = new SqlClientParameter(
                                 ...
                                 throw new Exception(); //NonConstantExpressionsNotSupportedFor("String.EndsWith");
                            }
                    ...
                    case "IndexOf":
                        if (mc.Arguments.Count == 1) {
                            ...
                            if (mc.Arguments[1].ClrType == typeof(StringComparison)) {
                                 throw new Exception(); //IndexOfWithStringComparisonArgNotSupported();
                            }
                    ...
                    case "LastIndexOf":
                        if (mc.Arguments.Count == 1) {
                            ...
                            // END
                            if (mc.Arguments[1].ClrType == typeof(StringComparison)) {
                                 throw new Exception(); //LastIndexOfWithStringComparisonArgNotSupported();
                            }
                    ...
                    case "Replace":
                        if (mc.Arguments[0] is SqlValue && ((SqlValue)mc.Arguments[0]).Value == null) {
                             throw new Exception(); //ArgumentNull("old");
                        }
                        if (mc.Arguments[1] is SqlValue && ((SqlValue)mc.Arguments[1]).Value == null) {
                             throw new Exception(); //ArgumentNull("new");
                        }
                        return sql.FunctionCall(
                ...
                switch (mc.Method.Name) {
                    ...
                    case "Round":
                        ...
                        if ((mc.Arguments[nParams - 1].ClrType != typeof(MidpointRounding))) {
                             throw new Exception(); //MathRoundNotSupported();
                        }
                        else {
                            SqlExpression x = mc.Arguments[0];
                            ...
                            if (roundingMethod.NodeType != SqlNodeType.Value) {
                                 throw new Exception(); //NonConstantExpressionsNotSupportedForRounding();
                            }
            ...
            internal override SqlNode VisitMember(SqlMember m) {
                ...
                if (baseClrTypeOfExpr == typeof(string) && member.Name == "Length") {
                    ...
                    switch (member.Name) {
                        ...
                        default:
                             throw new Exception(); //MemberCannotBeTranslated(member.DeclaringType, member.Name);
                    }
                }
                 throw new Exception(); //MemberCannotBeTranslated(member.DeclaringType, member.Name);
            }
            ...
            private SqlExpression TranslateVbLikeString(SqlMethodCall mc) {
                ...
                if (pattern.NodeType == SqlNodeType.Value) {
                    ...
                    pattern = new SqlClientParameter(
                     ...
                     throw new Exception(); //NonConstantExpressionsNotSupportedFor("LIKE");
                }
