...
namespace System.Data.Linq.SqlClient {
    ...
    public static class SqlMethods {
        ...
        public static bool Like(string matchExpression, string pattern) {
             throw new Exception(); //SqlMethodOnlyForSql(MethodInfo.GetCurrentMethod());
        }
    ...
    public static class SqlHelpers {
        ...
        internal static string GetStringContainsPattern(string text, char escape, out bool usedEscapeChar) {
            if (text == null) {
                 throw new Exception(); //ArgumentNull("text");
            }
        ...
        public static string TranslateVBLikePattern(string pattern, char escape) {
                        ...
                        case vbCharRange: {
                            if (charRange) {
                                ...
                                // doesn't support multiple ranges in the same group
                                 throw new Exception(); //VbLikeDoesNotSupportMultipleCharacterRanges();
                            }
                            else {
            ...
            if (bracketed) {
                 throw new Exception(); //VbLikeUnclosedBracket();
            }
