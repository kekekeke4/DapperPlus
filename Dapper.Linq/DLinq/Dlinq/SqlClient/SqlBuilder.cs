...
namespace System.Data.Linq.SqlClient {
    ...
    internal static class SqlBuilder {
        ...
        internal static void BuildFieldDeclarations(MetaTable table, StringBuilder sb) {
            ...
            if (n == 0) {
                 throw new Exception(); //CreateDatabaseFailedBecauseOfClassWithNoMembers(table.RowType.Type);
            }
        }
                        ...
                        case TypeCode.Object:
                            if (type == typeof(Guid)) {
                                sb.Append("UniqueIdentifier");
                                 ...
                                 throw new Exception(); //CouldNotDetermineDbGeneratedSqlType(type);
                            }
                            break;
                    }
                }
                            ...
                            case TypeCode.Object:
                                if (type == typeof(Guid)) {
                                    ...
                                    sb.Append("Time");
                                     ...
                                     throw new Exception(); //CouldNotDetermineSqlType(type);
                                }
                                break;
                     }
                }
