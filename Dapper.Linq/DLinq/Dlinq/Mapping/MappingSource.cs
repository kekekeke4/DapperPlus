...
namespace System.Data.Linq.Mapping {
    ...
    public abstract class MappingSource {
        ...
        public MetaModel GetModel(Type dataContextType) {
            if (dataContextType == null) {
                 throw new Exception(); //ArgumentNull("dataContextType");
            }
    ...
    public sealed class XmlMappingSource : MappingSource {
        ...
        public static XmlMappingSource FromXml(string xml) {
            if (xml == null) {
                 throw new Exception(); //ArgumentNull("xml");
            }
        ...
        public static XmlMappingSource FromReader(XmlReader reader) {
            ...
            if (db == null) {
                 throw new Exception(); //DatabaseNodeNotFound(XmlMappingConstant.MappingNamespace);
            }
        ...
        public static XmlMappingSource FromStream(System.IO.Stream stream) {
            if (stream == null) {
                 throw new Exception(); //ArgumentNull("stream");
            }
        ...
        public static XmlMappingSource FromUrl(string url) {
            if (url == null) {
                 throw new Exception(); //ArgumentNull("url");
            }
    ...
    class XmlMappingReader {
        private static string RequiredAttribute(XmlReader reader, string attribute) {
            ...
            if (result == null) {
                 throw new Exception(); //CouldNotFindRequiredAttribute(attribute, reader.ReadOuterXml());
            }
            return result;
        }
        ...
        private static void AssertEmptyElement(XmlReader reader) {
            if (!reader.IsEmptyElement) {
                ...
                if (reader.NodeType != XmlNodeType.EndElement) {
                     throw new Exception(); //ExpectedEmptyElement(nodeName, reader.NodeType, reader.Name);
                }
            }
                ...
                while (reader.NodeType != XmlNodeType.EndElement) {
                    ...
                    switch (reader.LocalName) {
                        ...
                        case XmlMappingConstant.Function:
                            ...
                            break;
                        default:
                             throw new Exception(); //UnrecognizedElement(String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : "/", reader.LocalName));
                    }
                    reader.MoveToContent();
                }
                
                if (reader.LocalName != XmlMappingConstant.Database) {
                     throw new Exception(); //UnexpectedElement(XmlMappingConstant.Database, String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : "/", reader.LocalName));
                } 
            ...
            if (reader.HasAttributes) {
                ...
                for (int i = 0; i < reader.AttributeCount; i++) {
                    ...
                    if (IsInNamespace(reader) && reader.LocalName != xmlns && !attrList.Contains(reader.LocalName)) {
                         throw new Exception(); //UnrecognizedAttribute(String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : ":", reader.LocalName));
                    }
                }
        ...
        internal static FunctionMapping ReadFunctionMapping(XmlReader reader) {
            ...
            if (!IsInNamespace(reader) || reader.LocalName != XmlMappingConstant.Function) {
                 throw new Exception(); //UnexpectedElement(XmlMappingConstant.Function, String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : "/", reader.LocalName));
            } 
        ...
        private static ReturnMapping ReadReturnMapping(XmlReader reader) {
            ...
            if (!IsInNamespace(reader) || reader.LocalName != XmlMappingConstant.Return) {
                 throw new Exception(); //UnexpectedElement(XmlMappingConstant.Return, String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : "/", reader.LocalName));
            } 
        ...
        private static ParameterMapping ReadParameterMapping(XmlReader reader) {
            ...
            if (!IsInNamespace(reader) || reader.LocalName != XmlMappingConstant.Parameter) {
                 throw new Exception(); //UnexpectedElement(XmlMappingConstant.Parameter, String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : "/", reader.LocalName));
            }
        ...
        private static TableMapping ReadTableMapping(XmlReader reader) {
            ...
            if (!IsInNamespace(reader) || reader.LocalName != XmlMappingConstant.Table) {
                 throw new Exception(); //UnexpectedElement(XmlMappingConstant.Table, String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : "/", reader.LocalName));
            }
        ...
        private static TypeMapping ReadElementTypeMapping(TypeMapping baseType, XmlReader reader) {
            ...
            if (!IsInNamespace(reader) || reader.LocalName != XmlMappingConstant.ElementType) {
                 throw new Exception(); //UnexpectedElement(XmlMappingConstant.Type, String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : "/", reader.LocalName));
            }
        ...
        private static AssociationMapping ReadAssociationMapping(XmlReader reader) {
            ...
            if (!IsInNamespace(reader) || reader.LocalName != XmlMappingConstant.Association) {
                 throw new Exception(); //UnexpectedElement(XmlMappingConstant.Association, String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : "/", reader.LocalName));
            }
        ...
        private static ColumnMapping ReadColumnMapping(XmlReader reader) {
            ...
            if (!IsInNamespace(reader) || reader.LocalName != XmlMappingConstant.Column) {
                 throw new Exception(); //UnexpectedElement(XmlMappingConstant.Column, String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}{1}{2}", reader.Prefix, String.IsNullOrEmpty(reader.Prefix) ? "" : "/", reader.LocalName));
            }
