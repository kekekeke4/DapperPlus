...
namespace LinqToDB
{
	...
	public class DataContext : IDataContext, IEntityServices
	{
		...
		/// <returns>Database transaction object.</returns>
		public virtual async Task<DataContextTransaction> BeginTransactionAsync(IsolationLevel level, CancellationToken cancellationToken = default(CancellationToken))
		{
			var dct = new DataContextTransaction(this);
		...
		/// <param name="cancellationToken">Asynchronous operation cancellation token.</param>
		/// <returns>Database transaction object.</returns>
		public virtual async Task<DataContextTransaction> BeginTransactionAsync(bool autoCommitOnDispose = true, CancellationToken cancellationToken = default(CancellationToken))
		{
			var dct = new DataContextTransaction(this);
