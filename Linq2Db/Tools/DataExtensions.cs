						...
						foreach (var item in sourceList)
						{
							switch (type)
							{
								case TypeCode.Byte:
									...
									break;
								case TypeCode.SByte:
									maxValue = (SByte)maxValue + 1;
									break;
								case TypeCode.Int16:
									maxValue = (Int16)maxValue + 1;
									break;
								case TypeCode.Int32:
									maxValue = (Int32)maxValue + 1;
									break;
								case TypeCode.Int64:
									maxValue = (Int64)maxValue + 1;
									break;
								case TypeCode.UInt16:
									maxValue = (UInt16)maxValue + 1;
									break;
								case TypeCode.UInt32:
									maxValue = (UInt32)maxValue + 1;
									break;
								case TypeCode.UInt64:
									maxValue = (UInt64)maxValue + 1;
									break;
								case TypeCode.Single:
									maxValue = (Single)maxValue + 1;
									break;
								case TypeCode.Decimal:
									maxValue = (Decimal)maxValue + 1;
									break;
								default:
